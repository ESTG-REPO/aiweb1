...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aiweb1
```

A live public deployment of this template is available at [https://aiweb1.templates.workers.dev](https://aiweb1.templates.workers.dev)
